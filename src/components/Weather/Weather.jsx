    ...
    <div className='weather-container'>
      <div className='weather-container__card'>
        <div className='weather-container__card-up'>
          ...
          <div className='weather-container__card-right'>
            <p>{convertDateFormat(weather.location.values[0].datetimeStr.substring(0, 10))}</p>
      ...
      <div className='weather-container__card'>
        <div className='weather-container__card-up'>
          ...
          <div className='weather-container__card-right'>
            <p>{convertDateFormat(weather.location.values[1].datetimeStr.substring(0, 10))}</p>
      ...
      <div className='weather-container__card'>
        <div className='weather-container__card-up'>
          ...
          <div className='weather-container__card-right'>
            <p>{convertDateFormat(weather.location.values[2].datetimeStr.substring(0, 10))}</p>
      ...
      <div className='weather-container__card'>
        <div className='weather-container__card-up'>
          ...
          <div className='weather-container__card-right'>
            <p>{convertDateFormat(weather.location.values[3].datetimeStr.substring(0, 10))}</p>
      ...
      <div className='weather-container__card'>
        <div className='weather-container__card-up'>
          ...
          <div className='weather-container__card-right'>
            <p>{convertDateFormat(weather.location.values[4].datetimeStr.substring(0, 10))}</p>
